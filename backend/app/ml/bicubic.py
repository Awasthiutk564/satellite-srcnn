...
def run_bicubic_super_resolution(
    ...
    The input is treated as the high-resolution reference. It is downscaled and
    then upscaled using bicubic interpolation to simulate the satellite imaging
    pipeline. Metrics are computed against the original HR image.
    \"\"\"
